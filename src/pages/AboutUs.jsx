...
export default function AboutUs() {
  ...
  <>
    ...
    <section className="container about" id="about">
      <section class="overflow-hidden pt-2 pb-12 lg:pt-[10px] lg:pb-[90px] ml-10 mr-10">
        <div class="container mx-auto">
          <div class="flex flex-wrap items-center justify-between -mx-4">
            <div class="w-full px-4 lg:w-6/12">
              <div class="flex items-center -mx-3 sm:-mx-4">
                <div class="w-full px-3 sm:px-4 xl:w-1/2">
                  <div class="py-3 sm:py-4 mt-12">
                    <img
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div class="mt-10 lg:mt-0">
                ...
                <p class="mb-5 text-base text-body-color text-white">
                  It is a long established fact that a reader will be distracted
                  by the readable content of a page when looking at its layout.
                  The point of using Lorem Ipsum is that it has a more-or-less.
                </p>
                <p class="mb-8 text-base text-body-color text-white">
